...
export const pipe: Pipe = (value: unknown, ...fns: any[]) => fns.reduce((v, fn) => fn(v), value)


export const hasProperty = <O extends object, K extends PropertyKey>(o: O,k: K): o is O & { [k in K]: unknown } => k in o 
...
export const setIndex = <T extends unknown[], I extends number, V>(xs: T, i: I, v: V) => {
    let ys = [...xs];
    ys[i] = v;
    return ys
}
